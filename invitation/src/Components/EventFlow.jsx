  ...
  const cardContent = [
    ...
    },
    {
      ...
      points: [
        ...
        `Tech & media collaboration – Connecting brands, content creators &
    ...
    },
    {
      ...
      description: "",
      points: [
        `Showcasing sponsor brands & partner organizations (Tech companies,
         media agencies, software firms, etc.)`,
